...
import agenda_controlador.exceptions.NonexistentEntityException;
...
public class PersonJpaController implements Serializable {
    ...
    //espesificamos la unidad de persistencia
    public PersonJpaController(){
        emf = Persistence.createEntityManagerFactory("createEntityManager");
    }
    ...
    public void edit(Person person) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = person.getPostalCode();
